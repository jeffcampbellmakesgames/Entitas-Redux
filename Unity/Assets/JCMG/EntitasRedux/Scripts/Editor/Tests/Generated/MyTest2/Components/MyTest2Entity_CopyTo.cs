...
public partial class MyTest2Entity
{
	/// <summary>
	...
	/// </summary>
	public void CopyTo(MyTest2Entity copyToEntity)
	{
		for (var i = 0; i < MyTest2ComponentsLookup.TotalComponents; ++i)
		{
			if (HasComponent(i))
			{
				if (copyToEntity.HasComponent(i))
				{
					throw new EntityAlreadyHasComponentException(
						...
						MyTest2ComponentsLookup.ComponentNames[i] +
						"' to " +
						this +
						"!",
	...
	/// </summary>
	public void CopyTo(MyTest2Entity copyToEntity, bool replaceExisting)
	{
		for (var i = 0; i < MyTest2ComponentsLookup.TotalComponents; ++i)
		{
			if (!HasComponent(i))
	...
	/// <summary>
	/// Copies components on this entity at <paramref name="indices"/> in the <see cref="MyTest2ComponentsLookup"/> to
	...
	/// </summary>
	public void CopyTo(MyTest2Entity copyToEntity, bool replaceExisting, params int[] indices)
	{
		for (var i = 0; i < indices.Length; ++i)
		{
			...
			if (index < 0 && index >= MyTest2ComponentsLookup.TotalComponents)
			{
				...
				throw new IndexOutOfLookupRangeException(
					string.Format(OUT_OF_RANGE_WARNING, index, nameof(MyTest2ComponentsLookup)),
					HINT);
			}
