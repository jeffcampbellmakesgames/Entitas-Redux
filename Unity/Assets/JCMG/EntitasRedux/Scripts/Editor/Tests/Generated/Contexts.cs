...
public partial class Contexts : JCMG.EntitasRedux.IContexts {
    ...
    public JCMG.EntitasRedux.IContext[] AllContexts { get { return new JCMG.EntitasRedux.IContext [] { Game, MyTest, Test, Test2 }; } }
...
public partial class Contexts {
    ...
    public const string EntitasReduxTestsCustomEntityIndex = "EntitasReduxTestsCustomEntityIndex";
    ...
    public void InitializeEntityIndices() {
        Test.AddEntityIndex(new EntitasRedux.Tests.CustomEntityIndex(Test));
...
public static class ContextsExtensions {
    ...
    public static System.Collections.Generic.HashSet<TestEntity> GetEntitiesWithPosition(this TestContext context, EntitasRedux.Tests.IntVector2 position) {
        return ((EntitasRedux.Tests.CustomEntityIndex)(context.GetEntityIndex(Contexts.EntitasReduxTestsCustomEntityIndex))).GetEntitiesWithPosition(position);
    }
    ...
    public static System.Collections.Generic.HashSet<TestEntity> GetEntitiesWithPosition2(this TestContext context, EntitasRedux.Tests.IntVector2 position, EntitasRedux.Tests.IntVector2 size) {
        return ((EntitasRedux.Tests.CustomEntityIndex)(context.GetEntityIndex(Contexts.EntitasReduxTestsCustomEntityIndex))).GetEntitiesWithPosition2(position, size);
    }
